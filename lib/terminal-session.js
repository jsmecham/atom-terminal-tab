...
export default class TerminalSession {
  ...
  constructor() {
    console.log('[TerminalTabSession] constructor()', arguments);
  ...
  //
  copySelection() {
    console.log('[TerminalTabSession] copySelection()');
    let selectedText = this.xterm.getSelection();
  ...
  getDefaultLocation() {
    console.log('[TerminalTabSession] getDefaultLocation()');
    return atom.config.get('terminal-tab.defaultLocation');
  }

  getIconName() {
    console.log('[TerminalTabSession] getIconName()');
    return 'terminal';
  }

  getTitle() {
    console.log('[TerminalTabSession] getTitle()');
    return 'Terminal';
  }
